...
class StyleTransferModel:
    def __init__(self):
        ...
        global content_layers_default, style_layers_default, device, device_cpu, cnn_normalization_mean, cnn_normalization_std, cnn
    ...
    def transfer_style(self, content_img_stream, style_img_stream):
        ...
        content_img = self.process_image(content_img_stream).clone()
        style_img = self.process_image(style_img_stream).clone()
        input_img = content_img.clone()

        output_img = self.run_style_transfer(cnn_normalization_mean, cnn_normalization_std, content_img, style_img, input_img)
        ...
        return self.backprocess_image(output_img)

    def backprocess_image(self, tensor):
    ...
    def run_style_transfer(self, normalization_mean, normalization_std,
        ...
        model, style_losses, content_losses = self.get_style_model_and_losses(normalization_mean, normalization_std, style_img, content_img, content_layers_default, style_layers_default)
